...
type lecturerStudentActivityLogHandler struct {
	*service.ServiceCtx
}

func (a lecturerStudentActivityLogHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	data, errs := a.LecturerStudentActivityLogService.GetList(ctx, paginationData, in.GetYear(), in.GetMonth())
	if errs != nil {
	...
	result = GetListResponse{
		Meta: &Meta{
			Message: "Get List Lecturer Student Activity Log",
