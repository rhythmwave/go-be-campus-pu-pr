...
func (a adminHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	defer a.AdminActivityLogService.Create(ctx, r, time.Now(), "Admin", "Get List", nil)
	...
	data, errs := a.AdminService.GetList(ctx, paginationData)
	if errs != nil {
...
func (a adminHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	defer a.AdminActivityLogService.Create(ctx, r, time.Now(), "Admin", "Create", &in)

	data := objects.CreateAdmin{
	...
	errs := a.AdminService.Create(ctx, data)
	if errs != nil {
		utils.PrintError(*errs)
		result = CreateResponse{
			Meta: &Meta{
...
func (a adminHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	defer a.AdminActivityLogService.Create(ctx, r, time.Now(), "Admin", "Update", &in)

	data := objects.UpdateAdmin{
		Id:       in.GetId(),
		Username: in.GetUsername(),
		Name:     in.GetName(),
		Password: in.GetPassword(),
	...
	errs := a.AdminService.Update(ctx, data)
	if errs != nil {
		utils.PrintError(*errs)
		result = UpdateResponse{
			Meta: &Meta{
...
func (a adminHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	defer a.AdminActivityLogService.Create(ctx, r, time.Now(), "Admin", "Delete", nil)

	errs := a.AdminService.Delete(ctx, in.GetId())
	if errs != nil {
		utils.PrintError(*errs)
		result = DeleteResponse{
			Meta: &Meta{
