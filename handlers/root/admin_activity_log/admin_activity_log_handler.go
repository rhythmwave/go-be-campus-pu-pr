...
func (a adminActivityLogHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	data, errs := a.AdminActivityLogService.GetList(ctx, paginationData, in.GetYear(), in.GetMonth())
	if errs != nil {
	...
	result = GetListResponse{
		Meta: &Meta{
			Message: "Get List Admin Activity Log",
