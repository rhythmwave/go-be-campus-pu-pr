...
type diktiStudyProgramHandler struct {
	*service.ServiceCtx
}

func (d diktiStudyProgramHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	data, errs := d.DiktiStudyProgramService.GetList(ctx, paginationData)
	if errs != nil {
	...
	result = GetListResponse{
		Meta: &Meta{
			Message: "Get List Dikti Study Program",
