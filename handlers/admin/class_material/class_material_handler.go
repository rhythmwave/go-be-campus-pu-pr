...
func (f classMaterialHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Class Material", "Get List", nil)
	...
	data, errs := f.ClassMaterialService.GetList(ctx, paginationData, in.GetClassId(), nil)
	if errs != nil {
