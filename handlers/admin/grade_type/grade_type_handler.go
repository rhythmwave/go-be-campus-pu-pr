...
func (f gradeTypeHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Grade Type", "Get List", nil)
...
func (f gradeTypeHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Grade Type", "Create", &in)
	...
	data := objects.CreateGradeType{
		StudyLevelId:       in.GetStudyLevelId(),
		Code:               in.GetCode(),
		GradePoint:         in.GetGradePoint(),
		MinimumGrade:       in.GetMinimumGrade(),
		MaximumGrade:       in.GetMaximumGrade(),
		GradeCategory:      in.GetGradeCategory(),
		GradePointCategory: in.GetGradePointCategory(),
		Label:              in.GetLabel(),
		EnglishLabel:       in.GetEnglishLabel(),
		StartDate:          startDate,
		EndDate:            endDate,
	}
	errs = f.GradeTypeService.Create(ctx, data)
	if errs != nil {
		utils.PrintError(*errs)
		result = CreateResponse{
			Meta: &Meta{
...
func (f gradeTypeHandler) Update(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Grade Type", "Update", &in)
	...
	errs = f.GradeTypeService.Update(ctx, data)
	if errs != nil {
		utils.PrintError(*errs)
		result = UpdateResponse{
			Meta: &Meta{
...
func (a gradeTypeHandler) Delete(w http.ResponseWriter, r *http.Request) {
	...
	defer a.AdminActivityLogService.Create(ctx, r, time.Now(), "Grade Type", "Delete", nil)

	errs := a.GradeTypeService.Delete(ctx, in.GetId())
	if errs != nil {
		utils.PrintError(*errs)
		result = DeleteResponse{
			Meta: &Meta{
