...
func (f classEventHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Class Event", "Get List", nil)
	...
	data, errs := f.ClassEventService.GetList(ctx, paginationData, in.GetClassId(), "", false, nil)
	if errs != nil {
