...
func (f classExamHandler) GetList(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Class Exam", "Get List", nil)
	...
	data, errs := f.ClassExamService.GetList(ctx, paginationData, appConstants.AppTypeAdmin, classIds)
	if errs != nil {
...
func (f classExamHandler) GetSubmission(w http.ResponseWriter, r *http.Request) {
	...
	defer f.AdminActivityLogService.Create(ctx, r, time.Now(), "Class Exam", "Get Submission", nil)
